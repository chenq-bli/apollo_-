...
#include "modules/planning/proto/planning.pb.h"//其实已经换过位置了，在/modules/common_msgs/planning_msgs位置了
...
class ControllerAgent {
 ...
 private:
  ...
  //Factory类是一个模板类，需要<ControlConf::ControllerType, Controller>参数，Factory中 
  //IdentifierType就是ControlConf::ControllerType  类AbstractProduct就是类Controller
  //而Controller这个类在#include "modules/control/controller/controller.h"文件中声明
